...
<div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-8">
                        ...
                        <tr>
                            <td colspan="6" class="actions">
                                <div class="flex flex-col lg:flex-row justify-between items-center gap-4 py-4">
                                    ...
                                    <div class="w-full lg:w-auto">
                                        <button type="submit" class="btn btn-secondary w-full lg:w-auto" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
                                    </div>
    ...
    <div class="lg:col-span-1">
        ...
        <div class="cart-collaterals card bg-base-200 shadow-xl">
            <div class="card-body">
                <?php
                /**

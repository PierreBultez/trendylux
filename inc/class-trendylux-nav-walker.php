    ...
    public function end_lvl( &$output, $depth = 0, $args = null ): void
    {
        if ( $depth === 0 && $this->is_mega_menu ) {
            ...
            if (stripos( $this->current_parent_title, 'luxe et créateurs' ) !== false ) {
                ...
                // Image 1 : Grande image verticale à gauche
                $output .= '<a href="' . home_url( '/categorie-produit/luxe-createurs/vetements-luxe-createurs/' ) . '" class="col-span-2 row-span-2 relative rounded-box overflow-hidden group shadow-lg block">';

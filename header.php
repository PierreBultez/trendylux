...
<header
        class="bg-neutral text-neutral-content relative z-[100]"
            ...
            <div class="navbar-center flex-grow max-w-xl hidden lg:block">
                <form class="w-xl" role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                    <label class="input input-bordered flex items-center gap-2 w-full relative">
                        ...
                        <input type="search" id="trendylux-search-input" class="grow text-primary-content" placeholder="Rechercher" name="s" value="<?php echo get_search_query(); ?>" autocomplete="off" />
                        <button type="submit" class="hidden" aria-label="Lancer la recherche"></button>
                        
                        <!-- AJAX Results Container -->
                        <div id="trendylux-search-results" class="absolute top-full left-0 w-full max-w-xl md:w-[650px] bg-base-100 shadow-2xl rounded-box mt-2 z-50 overflow-hidden hidden border border-base-200 p-0">
